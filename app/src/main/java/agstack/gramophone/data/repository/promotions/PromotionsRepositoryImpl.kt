...
class PromotionsRepositoryImpl @Inject constructor(
    ...
    override suspend fun getAllOffersList(offerListRequestModel: OfferListRequestModel): Response<PromotionsAllOfferResponse> =
        withContext(
            Dispatchers.IO) {
    ...
    override suspend fun getOfferDetails(offerDetailRequestModel: OfferDetailRequestModel): Response<PromotionsAllOfferResponse> =
        withContext(
            Dispatchers.IO) {
            val offersData = promotionsApiService.getOfferDetails(offerDetailRequestModel)
            offersData
        }
